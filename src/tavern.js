...
export class Tavern {
  ...
  _buildStations() {
    ...
    // ===== BEDROOM (back-right) — separate from the tavern proper =====
    mk('room', 'your Bedroom', 7, -12, (grp) => {
      ...
      const stand2 = new THREE.Mesh(new THREE.BoxGeometry(0.6, 0.7, 0.6), wood); stand2.position.set(1.1, 0.35, -0.8); grp.add(stand2);
    });

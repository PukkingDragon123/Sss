...
export const UPGRADE_RARITY = [
  ...
  { key: 'common',    name: 'Common',    color: '#7d7690', min: 9 },
  { key: 'rare',      name: 'Rare',      color: '#2f74c8', min: 7 },
  { key: 'epic',      name: 'Epic',      color: '#8a3ad0', min: 5 },
  { key: 'legendary', name: 'Legendary', color: '#b8741a', min: 0 },
];

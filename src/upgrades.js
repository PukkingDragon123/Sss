...
// Each upgrade mutates game.stats (and sometimes the wizard) when chosen.
...
export const UPGRADES = [
  ...
  { id: 'gust',      name: 'Howling Gale',    icon: '🌀', tag: 'Gust', weight: 6,
    desc: '+40% Gust force & range, +50% Gust damage.',
    apply: g => { g.stats.gustForce *= 1.4; g.stats.gustRange *= 1.4; g.stats.gustDmg *= 1.5; } },
  ...
  { id: 'drunk',     name: 'Liquid Courage',  icon: '🍺', tag: 'Risk', weight: 5,
